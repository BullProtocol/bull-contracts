...
// BSWAP Token with Governance.
contract ERC20Token is ERC20("BSWAP", "BSWAP"), Ownable {
    /// @notice Creates `_amount` token to `_to`. Must only be called by the owner (BSwapPool).
