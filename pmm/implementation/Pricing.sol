...
contract Pricing is Storage {
        ...
        returns (uint256 receiveQuoteToken)
    {
        ...
        uint256 Q2 = BSWAPMath._SolveQuadraticFunctionForTrade(
    ...
    {
        require(amount < targetBaseTokenAmount, "BSWAP_BASE_BALANCE_NOT_ENOUGH");
    ...
    function _RBelowBackToOne() internal view returns (uint256 payQuoteToken) {
        ...
        uint256 newTargetQuote = BSWAPMath._SolveQuadraticFunctionForTarget(
            _QUOTE_BALANCE_,
            _K_,
            fairAmount
        );
    ...
    function _RAboveBuyBaseToken(
        ...
        require(amount < baseBalance, "BSWAP_BASE_BALANCE_NOT_ENOUGH");
    ...
    function _RAboveBackToOne() internal view returns (uint256 payBaseToken) {
        ...
        uint256 newTargetBase = BSWAPMath._SolveQuadraticFunctionForTarget(
            _BASE_BALANCE_,
            _K_,
            fairAmount
        );
    ...
    function _RAboveIntegrate(
        ...
        uint256 i = getOraclePrice();
        return BSWAPMath._GeneralIntegrate(B0, B1, B2, i, _K_);
    }
    ...
    //     return BSWAPMath._GeneralIntegrate(Q0, Q1, Q2, i, _K_);
    // }
}
