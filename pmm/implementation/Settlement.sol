...
contract Settlement is Storage {
    ...
    function claimAssets() external preventReentrant {
        require(_CLOSED_, "BSWAP_NOT_CLOSED");
        ...
        IBSWAPLpToken(_BASE_CAPITAL_TOKEN_).burn(msg.sender, baseCapital);
        IBSWAPLpToken(_QUOTE_CAPITAL_TOKEN_).burn(msg.sender, quoteCapital);
