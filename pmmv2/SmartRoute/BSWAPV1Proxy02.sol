...
/**
 * @title BSWAPV1Proxy02
 * @author BSWAP Breeder
 *
 * @notice Entrance of trading in BSWAP platform
 */
contract BSWAPV1Proxy02 is IBSWAPV1Proxy02, InitializableOwnable {
    ...
    modifier judgeExpired(uint256 deadLine) {
        require(deadLine >= block.timestamp, "BSWAPV1Proxy02: EXPIRED");
        _;
    }
    ...
    function bswapSwapV1(
        ...
        require(bswapPairs.length > 0, "BSWAPV1Proxy02: PAIRS_EMPTY");
        require(minReturnAmount > 0, "BSWAPV1Proxy02: RETURN_AMOUNT_ZERO");
        require(fromToken != _CHI_TOKEN_, "BSWAPV1Proxy02: NOT_SUPPORT_SELL_CHI");
        ...
        if (fromToken != _ETH_ADDRESS_) {
            ...
            require(msg.value == fromTokenAmount, "BSWAPV1Proxy02: ETH_AMOUNT_NOT_MATCH");
        ...
        require(returnAmount >= minReturnAmount, "BSWAPV1Proxy02: Return amount is not enough");
    ...
    function externalSwap(
        ...
        require(isWhiteListed[swapTarget], "BSWAPV1Proxy02: Not Whitelist Contract");
        (bool success, ) = swapTarget.call{value: _fromToken == _ETH_ADDRESS_ ? msg.value : 0}(callDataConcat);

        require(success, "BSWAPV1Proxy02: External Swap execution Failed");
    ...
    function mixSwapV1(
        ...
        require(mixPairs.length == directions.length, "BSWAPV1Proxy02: PARAMS_LENGTH_NOT_MATCH");
        require(mixPairs.length > 0, "BSWAPV1Proxy02: PAIRS_EMPTY");
        require(minReturnAmount > 0, "BSWAPV1Proxy02: RETURN_AMOUNT_ZERO");
        require(fromToken != _CHI_TOKEN_, "BSWAPV1Proxy02: NOT_SUPPORT_SELL_CHI");
