...
import {IBSWAPV1Proxy01} from "./intf/IBSWAPV1Proxy01.sol";
import {InitializableOwnable} from "../lib/InitializableOwnable.sol";


/**
 * @title BSWAPV1Proxy01
 * @author BSWAP Breeder
 *
 * @notice Entrance of trading in BSWAP platform
 */
contract BSWAPV1Proxy01 is IBSWAPV1Proxy01, InitializableOwnable {
    ...
    uint8 public _GAS_BSWAP_MAX_RETURN_ = 0;
    ...
    modifier judgeExpired(uint256 deadLine) {
        require(deadLine >= block.timestamp, "BSWAPV1Proxy01: EXPIRED");
        _;
    }
    ...
    function updateGasReturn(uint8 newBSwapGasReturn, uint8 newExternalGasReturn) public onlyOwner {
    ...
    function bswapSwapV1(
        ...
        require(bswapPairs.length == directions.length, "BSWAPV1Proxy01: PARAMS_LENGTH_NOT_MATCH");
        ...
        if (fromToken != _ETH_ADDRESS_) {
            ...
            require(msg.value == fromTokenAmount, "BSWAPV1Proxy01: ETH_AMOUNT_NOT_MATCH");
            IWETH(_WETH_).deposit{value: fromTokenAmount}();
        }

        for (uint8 i = 0; i < bswapPairs.length; i++) {
        ...
        require(returnAmount >= minReturnAmount, "BSWAPV1Proxy01: Return amount is not enough");
        ...
        uint8 _gasBSwapMaxReturn = _GAS_BSWAP_MAX_RETURN_;
    ...
    function externalSwap(
        ...
        require(isWhiteListed[swapTarget], "BSWAPV1Proxy01: Not Whitelist Contract");
        (bool success, ) = swapTarget.call{value: _fromToken == _ETH_ADDRESS_ ? msg.value : 0}(callDataConcat);

        require(success, "BSWAPV1Proxy01: External Swap execution Failed");
    ...
    function mixSwapV1(
        ...
        require(mixPairs.length == directions.length, "BSWAPV1Proxy01: PARAMS_LENGTH_NOT_MATCH");
