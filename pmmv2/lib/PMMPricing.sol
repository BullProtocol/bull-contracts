...
library PMMPricing {
        ...
        )
    {
        ...
        return
            BSWAPMath._SolveQuadraticFunctionForTrade(
                state.Q0,
                state.Q0,
                payBaseAmount,
                state.i,
    ...
    function adjustedTarget(PMMState memory state) internal pure {
        if (state.R == RState.BELOW_ONE) {
            state.Q0 = BSWAPMath._SolveQuadraticFunctionForTarget(
                state.Q,
            ...
            state.B0 = BSWAPMath._SolveQuadraticFunctionForTarget(
                state.B,
